...
class Crew(models.Model):
    owner = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="owned_crews"
    )
    ...
    thumbnail_image = models.ImageField(
        upload_to="crews/thumbnail/%Y/%m/%d/", null=True
    )
...
class CrewReview(models.Model):
    ...
    author = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="reviewd_crews"
    )
