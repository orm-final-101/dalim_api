...
- 크루 즐겨찾기 기능을 통해 마음에 드는 크루를 저장하고 빠르게 접근할 수 있습니다.

### 9-2. 크루 리뷰 기능
(gif 넣어주고)
- 크루 회원들은 크루 활동에 대한 리뷰를 작성할 수 있습니다. 이를 통해 크루에 대한 피드백을 공유하고, 다른 사용자들에게 참고 정보를 제공합니다.
- 리뷰는 작성자만 수정 및 삭제할 수 있어 리뷰의 신뢰성을 유지합니다.

### 9-3. 크루 관리
(gif 넣어주고)
- 크루 관리자는 크루를 생성, 수정, 삭제할 수 있는 권한을 가지고 있습니다.
- 크루 멤버 관리 기능을 통해 크루 회원들의 상태를 효율적으로 관리할 수 있습니다.

### 9-5. 러닝 대회 정보 제공
(gif 넣어주고)
- races 앱에서는 다양한 러닝 대회 정보를 제공합니다. 사용자들은 대회 일정, 장소, 코스 등의 상세 정보를 확인할 수 있습니다.
- 대회 참가 신청 기능을 통해 원하는 대회에 손쉽게 등록할 수 있습니다.

### 9-6. 러닝 정보 공유
(gif 넣어주고)
- boards 앱에서는 러닝과 관련된 다양한 주제의 게시판을 제공합니다. 사용자들은 러닝 팁, 트레이닝 방법, 장비 추천 등의 정보를 공유하고 소통할 수 있습니다.

### 9-7. 러닝 기록 추적
(gif 넣어주고)
- 사용자는 자신의 러닝 활동을 기록할 수 있습니다. 달린 거리, 시간, 속도 등의 정보를 입력하면 'RunWithMe'에서 이를 추적하고 분석합니다.
- 사용자의 러닝 기록은 시각화된 통계와 함께 제공되어, 자신의 러닝 패턴과 진척도를 한 눈에 파악할 수 있습니다.
- 사용자는 자신의 러닝 기록을 다른 사용자와 공유할 수 있으며, 이를 통해 동기부여와 함께 러닝 커뮤니티 내에서의 상호작용을 촉진합니다.

### 9-8. 레벨 시스템
(gif 넣어주고)
- 사용자의 러닝 활동에 따른 레벨 시스템을 제공합니다. 사용자는 러닝 활동을 통해 경험치를 획득하고 레벨을 올릴 수 있습니다.
- 레벨 시스템은 사용자의 성취감을 높이고 동기부여를 유발합니다.
