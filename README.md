...
gantt
    ...
    section 프론트엔드(FE)
    작업시작(상품게시판제외): 24-04-01, 1d
    로그인, 회원가입, 메인 완료:24-04-02, 1d
    마이페이지,사용자 홈 완료:24-04-03, 1d
    크루리스트, 상세/대화 리스트, 상세 완료:24-04-04, 1d
    대화 어드민, 게시판: 24-04-05, 1d
    퍼블리싱 완료: milestone, isadded, 24-04-06, 0d
    작업된 API 연결(1차): 24-04-11, 1d 
    작업된 API 연결(2차): 24-04-13, 1d
    ...
    API 작성 및 테스트: 24-04-05, 7d
    기능 수정 및 ERD 작성: 24-04-12, 2d

    section 대회 앱 
    모델 확정: after a1, 24-04-03, 1d
    API 작성 및 테스트: 24-04-05, 6d
    테스트코드 작성 및 실행: 24-04-12, 2d
